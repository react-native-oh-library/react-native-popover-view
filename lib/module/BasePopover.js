...
export default class BasePopover extends Component {
  ...
  popoverRef = /*#__PURE__*/React.createRef();
  arrowRef = /*#__PURE__*/React.createRef();
  debug(line, obj) {
        ...
        callback: () => {
          if (this._isMounted) {
            ...
            if (this.props.debug || DEBUG) {
              setTimeout(() => this.popoverRef.current && getRectForRef(this.popoverRef).then(rect => this.debug('animateIn - onOpenComplete - Calculated Popover Rect', rect)));
              setTimeout(() => this.arrowRef.current && getRectForRef(this.arrowRef).then(rect => this.debug('animateIn - onOpenComplete - Calculated Arrow Rect', rect)));
            }
          }
  ...
  render() {
    ...
    const backgroundColor = flattenedPopoverStyle.backgroundColor || styles.popoverContent.backgroundColor;
    return /*#__PURE__*/React.createElement(View, {
      ...
      onLayout: evt => this.props.onDisplayAreaChanged(new Rect(evt.nativeEvent.layout.x, evt.nativeEvent.layout.y - FIX_SHIFT, evt.nativeEvent.layout.width, evt.nativeEvent.layout.height))
    }), /*#__PURE__*/React.createElement(Animated.View, {
      pointerEvents: "box-none",
      style: containerStyle
    }, this.props.showBackground !== false && /*#__PURE__*/React.createElement(TouchableWithoutFeedback, {
      ...
      onLayout: evt => {
        ...
        setTimeout(() => this._isMounted && this.measureContent(new Size(layout.width, layout.height)), 10);
      }
    }, this.props.children), geom.placement !== Placement.FLOATING && /*#__PURE__*/React.createElement(Arrow, {
      ref: this.arrowRef,
